...
import { atendimentos, calcularMetricas, calcularRankingClosers } from "@/data/mockData";
import { DollarSign, Users, TrendingUp, Target, Phone, Percent } from "lucide-react";
...
const Index = () => {
  ...
  const ranking = useMemo(() => {
    return calcularRankingClosers(atendimentos, dateRange.start, dateRange.end);
  }, [dateRange]);
